...
namespace AvantGarde.Projects
{
    ...
    public sealed class DotnetProject : PathItem
    {
        ...
        public DotnetProject? GetApp()
        {
            ...
            if (app != null && Solution?.Projects.TryGetValue(app, out DotnetProject? project) == true)
            {
                return project;
            }
        ...
        private ProjectError? CheckForError()
        {
            ...
            {
                return new ProjectError(this, "Assembly not found", "Build project or set custom path");
            }
